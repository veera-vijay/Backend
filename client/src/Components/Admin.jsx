            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              {userRole === "admin" && (
                <button
                  ...
                  className="w-full sm:w-auto bg-green-500 hover:bg-green-600 cursor-pointer text-white font-semibold py-3 px-6 rounded-full transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                >
              ...
              <button
                ...
                className="w-full sm:w-auto bg-purple-500 hover:bg-purple-600 cursor-pointer text-white font-semibold py-3 px-6 rounded-full transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg flex items-center justify-center gap-2"
              >
